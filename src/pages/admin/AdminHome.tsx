      ...
      <div className="grid md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
        {[
          ...
          <motion.div 
            ...
            className="bg-[#1E293B] p-8 rounded-[3rem] border border-slate-800 hover:border-brand-purple/50 transition-all group relative overflow-hidden"
          >
      ...
      <div className="bg-[#1E293B] rounded-[3.5rem] border border-slate-800 overflow-hidden shadow-2xl">
         <div className="p-12 border-b border-slate-800 flex items-center justify-between">
            <h3 className="text-2xl font-black font-display tracking-tight flex items-center gap-4">
               <ShieldAlert className="text-amber-500 w-8 h-8" /> CONTENT REVIEW QUEUE
            </h3>
            <span className="px-4 py-2 bg-amber-500/10 text-amber-500 rounded-xl text-xs font-bold tracking-widest uppercase">{stats.pending} ACTIONS REQUIRED</span>
         </div>
                    ...
                    <tr key={i} className="group hover:bg-slate-800/50 transition-colors">
                       <td className="px-12 py-8">
                          <div className="flex items-center gap-6">
                             ...
                             <div>
                                <h4 className="font-bold text-lg text-white group-hover:text-brand-blue transition-colors">{release.title}</h4>
                                <p className="text-xs text-slate-500 mt-1 font-medium">{release.label || "Independent"}</p>
                             </div>
                          </div>
                       </td>
                       <td className="px-6 py-8">
                          <div className="flex flex-col">
                             <span className="text-sm font-bold text-slate-300">{release.artist}</span>
