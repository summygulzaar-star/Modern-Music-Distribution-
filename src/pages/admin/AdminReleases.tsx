  ...
  return (
    <div className="space-y-10">
      <div className="flex items-center justify-between">
        <div>
           <h1 className="text-5xl font-black font-display tracking-tight uppercase">Master Catalog</h1>
           <p className="text-slate-400 font-medium">Full repository of all assets submitted across the global network.</p>
        </div>
                 ...
                 <tr key={i} className="group hover:bg-slate-800/50 transition-colors">
                    <td className="px-12 py-8">
                       <div className="flex items-center gap-6">
                          ...
                          <div>
                             <p className="font-bold text-white text-lg">{r.songName}</p>
                             <p className="text-[10px] text-slate-500 uppercase tracking-widest mt-1">ID: {r.id.slice(0, 8)}</p>
                          </div>
                       </div>
                    </td>
                    <td className="px-6 py-8 text-sm">
                       <p className="font-bold text-white uppercase text-xs truncate max-w-[150px]">{r.singerName || r.artist}</p>
                    ...
                    <td className="px-6 py-8 text-[10px] font-medium text-slate-400 space-y-1">
                       <p className="truncate max-w-[150px]"><span className="text-slate-600 font-bold uppercase mr-1">Singer:</span> {r.singerName}</p>
